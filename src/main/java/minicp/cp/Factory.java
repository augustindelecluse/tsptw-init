...
public final class Factory {
     ...
     */
    public static OldSeqVar makeSequenceVar(Solver cp, int nNodes, int begin, int end) {
        return new OldSeqVarImpl(cp, nNodes, begin, end);
    }
     ...
     * @return an uninstantiated boolean variable
     */
    public static SeqVar makeGraphSeqVar(Solver cp, int nNodes, int begin, int end) {
        return new SeqVarImpl(cp, nNodes, begin, end);
    }
